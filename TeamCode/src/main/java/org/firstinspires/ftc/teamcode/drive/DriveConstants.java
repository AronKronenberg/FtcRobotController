...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = 1.0 / rpmToVelocity(MAX_RPM); //0.02644; // 0.036196088299765307
    public static double kA = 0; //0.00091; // 0.0035
    public static double kStatic = 0; // 0.07331; // 0.001
